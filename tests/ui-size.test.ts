...
describe('desktop sizing', () => {
  ...
  it('renders the main view as a dark reference-style quota dashboard', () => {
    ...
    expect(appSource).toContain('void refreshQuota()')
  ...
  it('starts the widget as a compact floating ball', () => {
    ...
    expect(appSource).toContain('void refreshQuota()')
    expect(appSource).toContain('configureAutoRefresh(settings.value?.refreshIntervalMinutes || 5)')
    expect(appSource).not.toContain('minutes === 0 || isWidgetView')
