...
describe('desktop sizing', () => {
  it('keeps the main window at tool-window scale', () => {
    expect(mainWindowNumericProperty(mainSource, 'width')).toBeLessThanOrEqual(700)
    expect(mainWindowNumericProperty(mainSource, 'height')).toBeLessThanOrEqual(630)
  ...
  it('renders the main view as a dark reference-style quota dashboard', () => {
    ...
    expect(selectorNumericProperty(stylesSource, '.dashboard-panel', 'width')).toBeLessThanOrEqual(660)
    expect(selectorNumericProperty(stylesSource, '.dashboard-panel', 'height')).toBeLessThanOrEqual(590)
    ...
    expect(selectorNumericProperty(stylesSource, '.dashboard-view-tabs', 'height')).toBeLessThanOrEqual(24)
    expect(selectorNumericProperty(stylesSource, '.dashboard-control-strip', 'height')).toBeLessThanOrEqual(42)
    expect(selectorNumericProperty(stylesSource, '.quota-dial-card', 'height')).toBeLessThanOrEqual(160)
    expect(selectorNumericProperty(stylesSource, '.quota-dial', 'width')).toBeLessThanOrEqual(96)
    expect(selectorNumericProperty(stylesSource, '.reset-card-list', 'height')).toBeLessThanOrEqual(164)
    expect(selectorNumericProperty(stylesSource, '.usage-analytics-panel', 'margin-top')).toBeLessThanOrEqual(12)
  })
